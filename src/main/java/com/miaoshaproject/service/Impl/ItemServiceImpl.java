...
public class ItemServiceImpl implements ItemService {
    ...
    public boolean decreaseStock(Integer id, Integer amount) {
        ...
        if (result > 0) {
            ...
            // 打上库存售罄标识
            redisTemplate.opsForValue().set("promo_item_stock_invalid_"+id, "true");
            // 更新库存成功
            return true;
        } else {
    ...
    @Override
    public boolean increaseStock(Integer id, Integer amount) {
    ...
    private ItemModel convertModelFromDataObject(ItemDO itemDO, ItemStockDO itemStockDO) {
        ...
        itemModel.setPrice(new BigDecimal(itemDO.getPrice().doubleValue()));
